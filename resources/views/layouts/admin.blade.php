                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="{{ url('admin/products') }}" key="t-products">Produk</a></li>
                                    <li><a href="{{ url('admin/stocks') }}" key="t-orders">Stok</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    ...
                                    <span key="t-crypto">Transaksi</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ url('admin/transactions') }}" key="t-wallet">Status Pembayaran</a></li>
                                    {{-- <li><a href="crypto-buy-sell.html" key="t-buy">Log Pembayaran</a></li> --}}
