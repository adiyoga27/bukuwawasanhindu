...
<body data-sidebar="dark">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <form action="{{ url('logout') }}" method="post">
                                @csrf
                                <button class="dropdown-item text-danger" href="#" type="submit"><i
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <span key="t-ecommerce">Buku</span>
                            </a>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <span key="t-ecommerce">Artikel</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ url('admin/category-article') }}" key="t-product-detail">Kategori</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                ...
                                <li><a href="{{ url('admin/configs/about') }}" key="t-level-1-1">Tentang Kami </a>
                                </li>
                                <li><a href="{{ url('admin/configs/how-to-purchase') }}" key="t-level-1-1">Cara
                                        Pembelian </a></li>
    ...
    <script>
        $(document).ready(function() {
            // jika error atau sukses akan menampilkan sweeralert error 
            ...
            // error validator menggunakan sweetalert
            @if ($errors->any())
                let errors = '';
