            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">
                        ...
                        Silahkan isi data produk pada form di bawah ini. Data yang sudah diisi akan ditampilkan pada tabel di bawahnya.
                    </p>
                    ...
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                          ...
                          <div class="mb-3">
                           ...
                           <select class="form-control" name="category_id" required>
                                @foreach ($categories as $c)
                                    <option value={{ $c->id }} @if ($c->id == $item->category_id) selected
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="title" id="title" placeholder="Masukkan judul buku" value="{{ $item->title }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="categoryName" class="form-label">Pengarang</label>
                            <input type="text" class="form-control" name="author" id="author" placeholder="Masukkan nama pengarang buku ..." value="{{ $item->author }}" required>
                        </div>
                         ...
                         <div class="mb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="price" id="price" placeholder="Masukkan harga buku ..." value="{{ $item->price }}" required>    
                                </div>
                                <div class="col-md-6"> 
                                    <label for="categoryName" class="form-label">Diskon Harga</label>
                                    <input type="number" class="form-control" name="discount" id="discount" placeholder="Masukkan harga diskon buku ..."  value="{{ $item->discount }}" >    
                                </div>
                            </div>
                         </div>
                       <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('admin/products') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="categoryName" class="form-label">Judul Buku</label>
                            <input type="text" class="form-control" name="title" id="title" placeholder="Masukkan judul buku" required>
                        </div>
                        <div class="mb-3">
                            <label for="categoryName" class="form-label">Pengarang</label>
                            <input type="text" class="form-control" name="author" id="author" placeholder="Masukkan nama pengarang buku ..." required>
                        </div>
                         ...
                         <div class="mb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="categoryName" class="form-label">Harga</label>
                                    <input type="number" class="form-control" name="price" id="price" placeholder="Masukkan harga buku ..." required>    
                                </div>
                                <div class="col-md-6"> 
                                    <label for="categoryName" class="form-label">Diskon Harga</label>
                                    <input type="number" class="form-control" name="discount" id="discount" placeholder="Masukkan harga diskon buku ...">    
                                </div>
                            </div>
                         </div>
                       <div class="mb-3">
